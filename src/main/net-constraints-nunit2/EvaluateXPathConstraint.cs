...
namespace Org.XmlUnit.Constraints
{
    ...
    /// <summary>
    /// This NUnit2 Constraint verifies whether the evaluation of the
    ...
    public class EvaluateXPathConstraint : Constraint
    {
        ...
        private readonly IResolveConstraint valueConstraint;
        ...
        public EvaluateXPathConstraint(string xPath, IResolveConstraint valueConstraint)
        {
            this.xPath = xPath;
        ...
        public static EvaluateXPathConstraint HasXPath(string xPath, IResolveConstraint valueConstraint)
        {
        ...
        {
            string value = XPathEvaluate(o);
            return valueConstraint.Resolve().Matches(value);
        }

        /// <inheritdoc/>
        public override void WriteDescriptionTo(MessageWriter writer)
        {
            writer.Write("XML with XPath ");
            writer.Write(xPath);
            if (valueConstraint != null)
            {
                writer.Write(" evaluated to ");
                valueConstraint.Resolve().WriteDescriptionTo(writer);
            }
        }
        ...
        public override void WriteActualValueTo(MessageWriter writer)
        {
            if (valueConstraint != null)
            {
                valueConstraint.Resolve().WriteActualValueTo(writer);
            }
        }
