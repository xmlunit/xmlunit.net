...
namespace Org.XmlUnit.Constraints
{
    ...
    /// </code>
    /// </example>
    public class EvaluateXPathConstraint : PrefixConstraint
    {
        ...
        : base(valueConstraint, "result of XPath " + xPath)
        {
            this.xPath = xPath;
        ...
        {
            return "result of XPath " + xPath + " " + valueConstraint;
        }

        /// <inheritdoc/>
        public override ConstraintResult ApplyTo<TActual>(TActual actual)
        {
            string evaluationResult = XPathEvaluate(actual);
            ConstraintResult nested = valueConstraint.Resolve().ApplyTo(evaluationResult);
            return new EvaluateXPathConstraintResult(this, XPathEvaluate(actual), nested);
        }
        ...
        public class EvaluateXPathConstraintResult : ConstraintResult
        {
            ...
            {
                writer.Write("result of XPath {0}", constraint.xPath);
